...
use App\Containers\AppSection\User\Actions\GetByStatusAction;
...
class Controller extends ApiController
{
    ...
    public function getByStatus(GetByStatusRequest $request): array
    {
        $users = app(GetByStatusAction::class)->run($request);
        return $this->transform($users, UserTransformer::class);
    }
